...
public class InterfaceController {
  ...
  private void initialize() {
    assert connectToDevice
        != null : "fx:id=\"connectToDevice\" was not injected: check your FXML file 'MainScreen"
        + ".fxml'.";
    assert
        start != null : "fx:id=\"start\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert
        stop != null : "fx:id=\"stop\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert teamName
        != null : "fx:id=\"teamName\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert response
        != null : "fx:id=\"response\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert send
        != null : "fx:id=\"send\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert heartBeat
        != null : "fx:id=\"heartBeat\" was not injected: check your FXML file 'MainScreen.fxml'.";
    assert choiceBoxWeight
        != null : "fx:id=\"choiceBoxWeight\" was not injected: check your FXML file 'MainScreen"
        + ".fxml'.";
    assert choiceBoxSide
        != null : "fx:id=\"choiceBoxSide\" was not injected: check your FXML file 'MainScreen"
        + ".fxml'.";
    assert choiceBoxPos
        != null : "fx:id=\"choiceBoxPos\" was not injected: check your FXML file 'MainScreen"
        + ".fxml'.";
              ...
              if (status != tmp) {
                ...
                Platform.runLater(() -> {
                  approveButton.setDisable(
                      status != WarehouseRobotStatus.Waiting_for_approval_to_pickup);
                });
